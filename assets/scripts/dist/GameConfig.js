...
exports.PAYTABLE = (() => {
    const scaled = {};
    for (const [sym, pays] of Object.entries(_BASE_PAYTABLE)) {
        scaled[sym] = pays.map(v => v === 0 ? 0 : parseFloat((v * exports.PAYTABLE_SCALE).toFixed(4)));
    }
    return scaled;
})();
// ─── 符號顯示名稱（希臘神話主題）────────────────────────
...
exports.BASE_ROWS = 3;
exports.MAX_ROWS = 6;
exports.SYMBOL_W = 110; // square cell
exports.SYMBOL_H = 110; // square cell
exports.SYMBOL_GAP = 6;
exports.REEL_GAP = 6;
exports.CANVAS_W = 720;
exports.CANVAS_H = 1280;
exports.REEL_TOP_Y = 380; // reel area top Y from canvas center (frame top)
exports.REEL_START_X = -232; // leftmost reel center X
 ...
 * 翻到反面即 FG 結束。
 */
exports.COIN_TOSS_HEADS_PROB = [0.80, 0.68, 0.56, 0.48, 0.40];
/**
 * Entry Coin Toss 機率：進入 FG 前翻硬幣。
 * Main/EB: 80% → 可能失敗（Phase A 分數仍保留）。
 * Buy FG:  100% → 保證進入。
 */
exports.ENTRY_TOSS_PROB_MAIN = 0.80;
exports.ENTRY_TOSS_PROB_BUY = 1.00;
/**
 ...
 */
exports.FG_TRIGGER_PROB = 0.008;
// 雷霆祝福：第二擊觸發機率（GDD §5: 40%）
exports.TB_SECOND_HIT_PROB = 0.40;
exports.SYMBOL_UPGRADE = {
    'L4': 'P4', 'L3': 'P4', 'L2': 'P4', 'L1': 'P4',
    'P4': 'P3', 'P3': 'P2', 'P2': 'P1', 'P1': 'P1'
};
// 基礎連線數（3 列可見：25 條；展開後：57 條）
exports.LINES_BASE = 25; // BASE_ROWS 時的活躍連線數
exports.LINES_MAX = 57; // MAX_ROWS  時的活躍連線數
 ...
 */
exports.BUY_FG_PAYOUT_SCALE = 0.995;
/**
 ...
 */
exports.EB_BUY_FG_PAYOUT_SCALE = 1.065;
/**
